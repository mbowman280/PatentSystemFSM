// FSMUSPatentAct.cpp : main project file.
...
int main(array<System::String ^> ^args)
{
	...
	Console::Write("Input = bcd, Result = ");
	Console::WriteLine(try5);
	Console::Write("Input = aef, Result = ");
	Console::WriteLine(try6);
	Console::Write("Input = bceg, Result = ");
	Console::WriteLine(try7);
